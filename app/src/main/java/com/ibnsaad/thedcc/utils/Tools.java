...
public class Tools {
    ...
    public  String getFormattedDateOnly(Long dateTime) {
        SimpleDateFormat newFormat = new SimpleDateFormat("dd MMM yy");
        return newFormat.format(new Date(dateTime));
    }

    public  void directLinkToBrowser(Activity activity, String url) {
        try {
    ...
    private  String appendQuery(String uri, String appendQuery) {
        try {
